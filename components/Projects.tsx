...
const Projects = () => {
  return (
    <div className="h-fit w-full flex flex-col  items-center justify-center  gap-10 p-5 ">
      <div className="h-full w-full flex flex-col md:flex-row  items-center justify-center  gap-10 p-5 ">
